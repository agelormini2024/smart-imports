...
- `SI-FUNC-001` creado como contrato funcional del Matrix Validator.
...
| `docs/03-functional-specifications/si-func-001-matrix-validator.md` | Especificación funcional del Matrix Validator. |
...
1. Revisar y aprobar `SI-FUNC-001 — Matrix Validator`.
2. Crear la especificación técnica mínima.
3. Implementar validaciones de hojas, columnas, IDs y relaciones.
4. Agregar tests con `v3 aut(28)` y `v3 aut(29)`.
5. Volver al screening público de Margen Potencial del Nicho 2.
